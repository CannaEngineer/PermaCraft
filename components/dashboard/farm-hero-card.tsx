            ...
            <div>
              ...
              {showGPSActions && (
                <div className="flex flex-wrap gap-2 mt-2 animate-fade-in">
                  <Link
                    href={`/canvas?farm=${farm.id}&section=farm&gps=plant`}
                  ...
                  <Link
                    href={`/canvas?farm=${farm.id}&section=farm&gps=pin`}
                  ...
                  <Link
                    href={`/canvas?farm=${farm.id}&section=farm&gps=photo`}
                  ...
                  <Link
                    href={`/canvas?farm=${farm.id}&section=farm&gps=soil`}
                  ...
                  <Link
                    href={`/canvas?farm=${farm.id}&section=farm&gps=walk`}

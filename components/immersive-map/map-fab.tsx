...
import { Square, MapPin, Waves, Sparkles, Calendar, Leaf, BookOpen, Info } from 'lucide-react';
...
export function MapFAB({ onAddPlant, onWaterSystem, onBuildGuild, onTimeline, onJournalEntry, onFarmInfo }: MapFABProps) {

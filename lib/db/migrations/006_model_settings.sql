...
CREATE TABLE IF NOT EXISTS model_settings (
  ...
  image_generation_model TEXT NOT NULL DEFAULT 'google/gemini-2.5-flash-image',
...
VALUES ('default', 'x-ai/grok-4.1-fast', 'google/gemini-2.5-flash-lite', 'google/gemini-2.5-flash-image');

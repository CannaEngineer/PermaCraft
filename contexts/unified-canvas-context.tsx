...
export type CanvasSection = 'farm' | 'explore' | 'plants' | 'learn' | 'ai' | 'shop';
...
const validSections: CanvasSection[] = ['farm', 'explore', 'plants', 'learn', 'ai', 'shop'];

export function UnifiedCanvasProvider({ children, initialFarms }: UnifiedCanvasProviderProps) {
  const [activeSection, setActiveSectionRaw] = useState<CanvasSection>('farm');
